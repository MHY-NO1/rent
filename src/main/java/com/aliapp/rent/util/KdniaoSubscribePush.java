...
public class KdniaoSubscribePush {
    ...
    /*public static void main(String[] args) {
        try {
            KdniaoSubscribePush api = new KdniaoSubscribePush();
    ...
    //物流跟踪接口(增值版)
    public String orderOnlineByJson(String Callback, String ShipperCode,
                                    String LogisticCode, String phone) {
        // 组装应用级参数
        String RequestData;
        ...
        params.put("RequestType", "8008");//在途监控订阅接口指令8008/地图版订阅接口指令8005/免费版1008 申通圆通百世天天
        String dataSign = null;
        try {
            dataSign = encrypt(RequestData, ApiKey, "UTF-8");
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
        ...
        if (success.equals("true")) {
            return jsonObject.getString("EBusinessID");
        }
        return null;
    }
